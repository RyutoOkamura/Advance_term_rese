    <x-home>
        ...
        <x-slot name="logo">
            <div class="sm:flex items-center sm:justify-srtart">
                ...
                <!-- 検索機能表示 -->
                <form action="/result" method="get" class="p-8 sm:mr-24">
                    @csrf
                    <div class="sm:flex shadow-lg border rounded-md bg-white">
                        ...
                        {{-- キーワード検索 --}}
                        <div class="container justify-start w-25vw">
            ...
            <div class="flex justify-between pl-6 pr-6 flex-wrap sm:pt-28 pt-42vh">
                ...
                <div class="lg:w-22vw md:w-29vw sm:w-42vw bg-white rounded-md shadow-md pb-4 ml-2 mr-2 mt-2">
                    ...
                    <div class="pt-4 pl-4 flex items-center justify-between">
                        <a href="{{ route('getdetail', ['id'=>$restaurant->id]) }}" class="text-white bg-rese pl-3 pr-3 pt-1 pb-1 rounded-md">詳しくみる</a>
                        <button>
